...
export function About() {
  return (
    <>
      <section className="relative bg-gradient-to-br from-teal-50 to-blue-50 py-20" aria-labelledby="about-heading">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 id="about-heading" className="text-4xl sm:text-5xl mb-6 text-gray-900">
                Our Story
              </h1>
            ...
            <div className="rounded-lg overflow-hidden shadow-2xl">
              <ImageWithFallback
                ...
                alt="Ornate pink palace facade with traditional Indian architecture and many decorative windows"
      ...
      <section className="py-20 bg-white" aria-labelledby="origin-heading">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 id="origin-heading" className="text-3xl mb-8 text-gray-900 text-center">How It All Began</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12 items-center">
              ...
              <div className="rounded-lg overflow-hidden shadow-lg order-1 md:order-2">
                <ImageWithFallback
                  ...
                  alt="Musicians performing traditional Indian music outdoors with instruments"
                  className="w-full h-full object-cover aspect-square"
                />
              </div>
            </div>

            <div className="bg-teal-50 rounded-lg p-8 mb-12" aria-labelledby="mission-heading">
              <h3 id="mission-heading" className="text-2xl mb-4 text-gray-900">Our Mission</h3>
              <p className="text-lg text-gray-700 leading-relaxed">
      ...
      <section className="py-20 bg-gray-50" aria-labelledby="values-heading">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 id="values-heading" className="text-3xl mb-12 text-gray-900 text-center">What Drives Us</h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <article className="bg-white rounded-lg p-6 text-center shadow-md">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <figure className="rounded-lg overflow-hidden shadow-xl">
              <ImageWithFallback
                ...
                alt="Chef in traditional apron preparing Indian cuisine in commercial kitchen"
                className="w-full h-full object-cover aspect-[4/3]"
              />
            </figure>
            <figure className="rounded-lg overflow-hidden shadow-xl">
              <ImageWithFallback
                ...
                alt="Woman in traditional dress working with colorful Indian textiles and embroidery"
                className="w-full h-full object-cover aspect-[4/3]"
              />
            </figure>
          </div>
      ...
      <section className="py-20 bg-white" aria-labelledby="cta-heading">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 id="cta-heading" className="text-3xl mb-6 text-gray-900">Join Us on This Journey</h2>
          ...
          <nav aria-label="Call to action buttons">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/experiences"
                className="px-8 py-3 bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-600 focus:ring-offset-2 text-white rounded-md transition-colors inline-block"
              >
                Explore Experiences
              </a>
              <a
                href="/request"
                className="px-8 py-3 border border-teal-600 text-teal-600 hover:bg-teal-50 focus:outline-none focus:ring-2 focus:ring-teal-600 focus:ring-offset-2 rounded-md transition-colors inline-block"
              >
